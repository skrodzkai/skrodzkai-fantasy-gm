...
import { applyFreshAdpSnapshot, adpSourceHealth, canonicalTeam, canonicalName, identityKey } from "./market-adp.mjs";
export { applyFreshAdpSnapshot } from "./market-adp.mjs";
