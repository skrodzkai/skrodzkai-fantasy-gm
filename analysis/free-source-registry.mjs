export const FREE_SOURCE_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    ...
    role: "deterministic historical baseline, weekly outcome and availability calibration, schedules, rosters, snap counts, and cross-provider player identifiers",
    access: "public nflverse release artifacts",
    cost: "free",
    constraints: "weeks 1-17 only; PFR snap identities require exact same-season roster crosswalk; current projections never backfill historical publisher accuracy; code is open source and underlying NFL data remains governed by its owners' terms",
    maximumRefreshHours: 168,
