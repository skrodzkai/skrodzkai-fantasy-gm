...
export function extensionBoardFromV5(board) {
  ...
  return {
    ...
    replacementRoster: board.replacementRoster ?? null,
    sourceExpirations: board.sourceExpirations ?? null,
...
export function renderExtensionBoard(board, { mode = "TEST" } = {}) {
  ...
  const runtimeBoard = {
    ...
    marketAdpReceipt:board.marketAdpReceipt,
    replacementBySlot: board.replacementBySlot,
    replacementRoster: board.replacementRoster,
    sourceExpirations: board.sourceExpirations,
