...
test('dated research packet contains 37 distinct narrative profiles and three official role holds', async()=>{
  ...
  assert.equal(news.length,37);assert.equal(new Set(news.map(r=>r.playerId)).size,37);
