...
test("builds a sanitized report while excluding Joe from opponent analytics", () => {
  ...
  const report = buildV5ReadinessReport({
    ...
    playerBoard: {
      ...
      players: [
        { yahooId: "99001", position: "WR", yahooPosition: "WR", yahooEligibilityFilters: ["O"], eligible: ["WR"], consensusPoints: 92, executable: false },
        { yahooId: "99002", position: "CB", yahooPosition: "CB", yahooEligibilityFilters: ["DB"], eligible: ["CB", "DB"], consensusPoints: 90, executable: false },
      ],
    },
